...
df_merged = data_process({'produit':os.path.join(current_dir,r'data\produit.csv'), 
                           'temps':os.path.join(current_dir,r'data\temps.csv') , 
                           'vente':os.path.join(current_dir,r'data\vente.csv')})
...
app.layout = html.Div([
    ...
    html.Div([
            ...
            lines.quantite_revenu_mensuels_cat_render(df_merged, app)
    ], className="stats-container"),
    ...
    html.Div([
            ...
            lines.quantite_revenu_mensuels_prod_render(df_merged, app)
    ], className="stats-container")
])
